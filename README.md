...
This simple route handles ~45000 rps, with 99% taking less than 1ms:<br>
`ab -n 10000 -c 10 http://localhost:8080/api/hello`

JDBC access route handles ~11000 rps, with 99% taking less than 1ms:<br>
...
Tests ran on Ubuntu, Java 25, Intel Core Ultra 9 386H Laptop CPU.
